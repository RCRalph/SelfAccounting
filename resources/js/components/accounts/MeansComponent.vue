...
import AddMeanDialogComponent from "@/accounts/AddMeanDialogComponent.vue";
import EditMeanDialogComponent from "@/accounts/EditMeanDialogComponent.vue";
...
export default {
    ...
    methods: {
        getData() {
            ...
            axios
                .get(`/web-api/means/${this.currencies.usedCurrency}`)
                .then(response => {
