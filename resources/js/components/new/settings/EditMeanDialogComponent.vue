<template>
    <v-dialog v-model="dialog" max-width="700">
        ...
        <v-card v-if="ready">
            <v-card-title>Edit mean of payment</v-card-title>
            ...
            <v-card-text>
                <v-form v-model="canSubmit">
                    ...
                    <v-row>
                        ...
                        <v-col cols="12" sm="4">
                            <v-text-field type="date" label="First entry date" v-model="data.first_entry_date" min="1970-01-01" :max="data.max_date" :rules="[validation.date(false)]"></v-text-field>
                        </v-col>
...
export default {
    ...
    watch: {
        dialog() {
            ...
            axios
                .get(`/web-api/settings/means/${this.id}`)
                .then(response => {
    ...
    methods: {
        ...
        update() {
            ...
            axios
                .patch(`/web-api/settings/means/${this.id}`, this.data)
                .then(() => {
