            ...
            <v-card-text>
                        ...
                        <v-row>
                            ...
                            >
                                ...
                                <div
                                    ...
                                    style="overflow-x: hidden"
                                >
                                    {{ format.numberWithCurrency(cash[id], props.currency.ISO) }}
                                </div>
                            </v-col>
                            ...
                            >
                                ...
                                >
                                    {{
                                        format.numberWithCurrency(model[id] * cash[id] || 0, props.currency.ISO)
                                    }}
                                </div>
                            </v-col>
                ...
                <v-row>
                    ...
                    >
                        ...
                        >
                            {{
                                format.numberWithCurrency(sum, props.currency.ISO)
                            }}
                        </div>
                    </v-col>
                    ...
                    >
                        ...
                        >
                            {{
                                format.numberWithCurrency(props.sumByAccount[cashAccount], props.currency.ISO)
                            }}
                        </div>
                    </v-col>
