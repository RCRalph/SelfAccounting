                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-9 mx-auto">
                            <h1 class="mb-5">Start self-accounting today!</h1>
                        </div>
                ...
                <div class="container-fluid p-0">
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-6 order-lg-1 my-auto showcase-text">
                            ...
                            <p class="lead mb-0">
                                The ease of self-accounting is very important to us. That's why we created this website and will continue to improve and expand in the future!
                            </p>
                        </div>
                    </div>
            ...
            <section class="call-to-action text-white text-center">
                <div class="overlay"></div>
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-9 mx-auto">
                                <h1 class="mb-5">What are you waiting for?</h1>
                            </div>
                            <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
                                <div class="col-12 col-md-4 mx-auto">
                                    <a role="button" class="btn btn-block btn-lg btn-dark" href="/register">Register now!</a>
