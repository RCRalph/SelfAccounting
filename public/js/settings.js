...
/* harmony import */ var _settings_categories_Categories_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./settings/categories/Categories.vue */ "./resources/js/components/settings/categories/Categories.vue");
/* harmony import */ var _settings_means_of_payment_MeansOfPayment_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./settings/means-of-payment/MeansOfPayment.vue */ "./resources/js/components/settings/means-of-payment/MeansOfPayment.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    Categories: _settings_categories_Categories_vue__WEBPACK_IMPORTED_MODULE_0__["default"],
    Means: _settings_means_of_payment_MeansOfPayment_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      currencies: [],
  ...
  mounted: function mounted() {
    ...
    axios.get("/webapi/settings", {}).then(function (response) {
      _this3.currencies = response.data.currencies; // Categories
    ...
    _c("td", [
      _c("input", {
        ...
        class: [
          ...
          !_vm.content.first_entry_date && "border-large"
        ],
        attrs: { type: "date" },
      ...
      _c("input", {
        ...
        class: [
          ...
          parseFloat(_vm.content.first_entry_amount) !=
            _vm.content.first_entry_amount && "border-danger",
          parseFloat(_vm.content.first_entry_amount) !=
