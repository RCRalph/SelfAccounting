...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    categoriesSave: function categoriesSave() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post("/webapi/settings/categories", {
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("/webapi/settings", {}).then(function (response) {
      _this2.currencies = response.data.currencies;
      _this2.categories = _objectSpread({}, response.data.categories);
      _this2.categoriesCopy = _.cloneDeep(_objectSpread({}, response.data.categories));
      _this2.ready = true;
    });
  }
});
  ...
  return _c("tr", { attrs: { i: _vm.index } }, [
    _c("td", [
      _c("input", {
        ...
        attrs: { type: "text", placeholder: "Name of the category" },
